   ...
   <header class="w-64 h-64">
     <div class="w-64 mt-24 ml-2 relative md:fixed">
       <div class="flex">
         ...
         <div>
           <h1 class="font-bold">akihiro sato</h1>
           <p class="text-xs text-justify">フロントエンドエンジニアのsato akihiroです。Vue.js, Nuxt.jsが大好きです。railsも使います。ご依頼はDMからどうぞ。</p>
         </div>
       </div>
...
.photo {
  min-width: 4rem; 
  min-height: 4rem;
  background-image: url("~assets/sabo.jpg")
}
button:focus {
  outline: none;
}
